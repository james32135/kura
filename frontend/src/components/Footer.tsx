    ...
    <footer className="relative border-t border-border/60 mt-32">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
          ...
          <div className="grid grid-cols-3 gap-10 text-sm">
            ...
            <div className="space-y-3">
              ...
              <a href="#" className="flex items-center gap-1.5 text-foreground/80 hover:text-foreground"><BookOpen className="h-3.5 w-3.5" />Whitepaper</a>
              <a href="#" className="flex items-center gap-1.5 text-foreground/80 hover:text-foreground"><Network className="h-3.5 w-3.5" />Architecture</a>
              <a href="#" className="flex items-center gap-1.5 text-foreground/80 hover:text-foreground"><Github className="h-3.5 w-3.5" />GitHub</a>
            </div>
            <div className="space-y-3">
              <p className="text-xs uppercase tracking-widest text-muted-foreground">Network</p>
              <p className="text-foreground/80">Base Sepolia</p>
        ...
        <div className="mt-14 pt-6 border-t border-border/50 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-xs text-muted-foreground">
          ...
          <p className="font-mono">v0.1.0 · base-sepolia</p>
        </div>
      </div>
    </footer>
  );
